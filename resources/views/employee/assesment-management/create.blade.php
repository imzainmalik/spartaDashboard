            ...
            <form action="" method="post" id="main-form" class="needs-validation" novalidate
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <select class="customjs-select2 form-control" name="cutomer" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group textArea">
                                            ...
                                            <textarea name="notes[{{ $question->type_id }}]" id=""></textarea>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    @if ($question->answerOption != null)
                                                        ...
                                                        @foreach ($question->answerOption as $option)
                                                            ...
                                                            @if ($option->ans_input_type == 0)
                                                                @if ($option->ans_text != null)
                                                                    <input type="radio" required
                                                                        id="option_{{ $option->ans_text . '_' . $index }}"
                                                                        name="answer[{{ $question->id }}]"
                                                                        value="{{ $option->id }}"
                                                                        class="form form-check-input">
                                                                    <label
                                                                        for="option_{{ $option->ans_text . '_' . $index }}">{{ $option->ans_text }}</label>
                                                                    &nbsp; &nbsp;
                                                                    <div class="invalid-feedback">Please select an option.
                                                                    </div>
                                                                @endif
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            nextBtn.addEventListener('click', function(e) {
                ...
                if (currentStepIndex === steps.length - 1) {
                    ...
                    $.ajax({
                        'url': '{{ route('admin.assessment-management.store') }}',
                        'type': 'POST',
                        'data': formData,
